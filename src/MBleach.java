...
public class MBleach extends Movies
{
	public void typeOfAMovie() 
	{
		
		  String Type="Movies";
		  String Plot="  In Karakura Town, there has been a sudden outbreak of unidentifiable spirits called blanks (vacant souls) while in the skies of Soul Society, the real world has been reflected";	
		  String Genre="Action, Comedy, Martial Arts, Shounen, Super Power";
		  int Released=2006;
		  String Status="Completed";
		  String Other=" Bleach Movie : Memory Of Nobody";
		  int Ep=01;
				  
		  System.out.println("Anime Info :-        ");
		  System.out.println("");
		  System.out.println("Bleach Movie     " );
		  System.out.println("");
 	   ...
 	   {
			case 1:
				System.out.println("https://www1.gogoanimes.fi/category/bleach-movie-1-memories-of-nobody-dub");
			...
			case 2:
				System.out.println("https://www1.gogoanimes.fi/category/bleach-movie-1-memories-of-nobody");
				System.out.println("Copy Link And Paste One Browser!!!!");
