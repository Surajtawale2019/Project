...
public class OnePieceSub extends Sub 
{
	public void typeOfAnime() 
	{
		  ...
		  System.out.println("One Piece Sub     " );
 	   ...
 	   {
			case 1:
				System.out.println("https://www1.gogoanime.bid/category/one-piece-Sub");
			...
			default:
				...
				OnePieceSub h1  = new OnePieceSub();
				 h1.typeOfAnime();
		}
	}
