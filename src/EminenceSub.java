...
public class EminenceSub extends Sub
{
	public void typeOfAnime() 
	{
		  ...
		  System.out.println("");
		  System.out.println("The Eminence in Shadow Sub     " );
		  System.out.println("");
 	   ...
 	   {
			case 1:
				System.out.println("https://www1.gogoanimes.fi/category/kage-no-jitsuryokusha-ni-naritakute");
