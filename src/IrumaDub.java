...
public class IrumaDub extends Dub
{
	public void typeOfAnime() 
	{
		  ...
		  System.out.println("");
		  System.out.println(" Welcome to Demon School! Iruma-kun Dub     " );
		  System.out.println("");
 	   ...
 	   {
			case 1:
				System.out.println("https://www1.gogoanimes.fi/category/mairimashita-iruma-kun-dub\r\n");
