...
public class MAttack extends Movies
{
	public void typeOfAMovie() 
	{
		
		  String Type="Movies";
		  String Plot="Recap of episodes 1-13. ";
		  String Genre=" Action, Drama, Fantasy, Shounen, Super Power";
		  int Released=2014;
		  String Status="Completed";
		  String Other=" Attack on Titan: Crimson Bow and Arrow,";
		  int Ep=01;
				  
		  System.out.println("Anime Info :-        ");
		  System.out.println("");
		  System.out.println("Attack On Titan Movie     " );
		  System.out.println("");
 	   ...
 	   {
			case 1:
				System.out.println("https://www1.gogoanimes.fi/category/shingeki-no-kyojin-movie-1-guren-no-yumiya-dub");
			...
			case 2:
				System.out.println("https://www1.gogoanimes.fi/category/shingeki-no-kyojin-movie-1-guren-no-yumiya");
				System.out.println("Copy Link And Paste One Browser!!!!");
