...
public class DemonSlayerDub extends Dub
{
	public void typeOfAnime() 
	{
		  ...
		  System.out.println("");
		  System.out.println("Demon Slyer Dub     " );
		  System.out.println("");
 	   ...
 	   {
			case 1:
				System.out.println("https://ww3.gogoanime2.org/anime/kimetsu-no-yaiba-dub");
				...
				System.out.println("");
				 ...
				 if(x1==1)
				 {
					 DemonSlayerDub h  = new DemonSlayerDub();
					 h.typeOfAnime();
				 }
				 else if(x1==2)
				 {
