...
public class NewSeason extends Anime
{
	...
	{	
		System.out.println("");
		System.out.println("***************************************");
		System.out.println(" Anime NewSeason !!! ");
		System.out.println("***************************************");
		System.out.println("");
	}
	
	public void typeOfANew()
	{
		
		System.out.println("You have selected Anime New Season ");
		System.out.println();
		
		
		System.out.println("Select the New Anime Season You Want To Watch :- ");
		
		System.out.println("Press 1 to select NARUTO ");
		System.out.println("Press 2 to select ONE PIECE  ");
		...
		System.out.println("Press 10 to select Iruma kun ");
		System.out.println();
		System.out.println();
